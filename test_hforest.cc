...
// create three trees and add them to the forest
...
//test the pop_tree by poping and examining the poped off value	
	...
	auto secondlargest = forest1.pop_tree();
    std::cout << largest->get_value() << "\n";
	std::cout << secondlargest->get_value() << "\n";
if (largest->get_value() == 107 and secondlargest->get_value() == 104)
{
